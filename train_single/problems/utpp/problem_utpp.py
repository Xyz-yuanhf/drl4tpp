...
from train_single.problems.utpp.state_utpp import StateUTPP
...
class UTPPDataset(Dataset):
    ...
    def __init__(self, filename=None, num_samples=1280, num_reuse=1,
                 graph_size=50, num_products=50, max_price=10):
        if filename is not None:
            ...
            if num_reuse == 1:
                self.data = [
                    generate_utpp_instance(graph_size, num_products, max_price)
