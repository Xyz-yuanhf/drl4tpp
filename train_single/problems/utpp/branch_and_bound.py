...
# Create variables
x = m.addVars(dist.keys(), obj=dist, vtype=GRB.BINARY, name='x')  # Decision x_ij
y = m.addVars(num_city, vtype=GRB.BINARY, name='y')  # Decision y_i
z = []
for prod_id in range(num_prod):    # Decision z_ik
